...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound4 = sp.load(getApplicationContext(), R.raw.hh1, 1);
        sound5 = sp.load(getApplicationContext(), R.raw.oh1, 1);
        sound6 = sp.load(getApplicationContext(), R.raw.clap1, 1);
        sound7 = sp.load(getApplicationContext(), R.raw.snare1, 1);
        sound8 = sp.load(getApplicationContext(), R.raw.kick1, 1);
        sound9 = sp.load(getApplicationContext(), R.raw.perc1, 1);
    }
